...
- 31b4d0e: Add patch applied callback API for server sync and side effects
...
- 2962bba: Add `parseCanvasdown` function for synchronous parsing without React hooks
